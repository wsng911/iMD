<template>
  <div class="viewer">
    <div class="viewer-toolbar">
      ...
      <button class="back-home-btn" @click="$emit('back')">返回</button>
    </div>
    <div class="viewer-body">
      ...
      <template v-if="headings.length">
        <!-- fab 固定在右侧 -->
        <button class="outline-fab" :class="{ open: drawerOpen, 'fab-hidden': isMobile && props.mobilePage === 'sidebar' }" @click="drawerOpen = !drawerOpen">
